<template>
  <div>
    <!--  v-if="deteccionesConteoDiario != undefined"-->
    <!-- AREA CHART -->
    <div class="box bgg-sfbox radius-general">
      ...
      <div class="box-body chart-responsive">
        <div class="chart" id="revenue-chart" style="height: 29vh"></div>
    ...
    async mounted() {
      ...
      if (this.deteccionesConteoDiario == undefined ||
        ...
        for (let contador = 6; contador < 19; contador++) {
          if (contador < 12) {
            let horaDummy = {
              fechaHora: `2021-01-01 0${contador}:00`,
              porcentajeCasco: 0,
              porcentajeChaleco: 0
            }
            ...
            let horaDummy = {
              fechaHora: `2021-01-01 ${contador}:00`,
              porcentajeCasco: 0,
              porcentajeChaleco: 0
            }
            datosDummy.push(horaDummy)
